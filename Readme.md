...
- Edit the opentherm.yaml file:
    a. Make sure the board and device settings are correct for your device
    b. Set the sensor entity_id with the external temperature sensor's name from Home Assistant. (The ESPHome sensor name is temperature_sensor).
